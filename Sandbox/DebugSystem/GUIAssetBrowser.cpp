...
@team   :  MonkeHood
@course :  CSD2401
@file   :  GUIAssetBrowser.cpp
@brief  :  This file contains the function definition of ImGui asset browser
...
//Handle add, update and delete of assets
...
//Cut the string to fit the width of the thumbnail
